...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { name: @district.name, project_id: @district.project_id, user_id: @district.user_id } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { name: @district.name, project_id: @district.project_id, user_id: @district.user_id } }
